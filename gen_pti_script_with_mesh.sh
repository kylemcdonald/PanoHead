...
for i in 0 1; do
    ...
    python gen_videos_proj_withseg.py --output="${output_dir}/${model}/${i}/PTI_render/post.mp4" --latent="${output_dir}/${model}/${i}/projected_w.npz" --trunc 0.7 --network "${output_dir}/${model}/${i}/fintuned_generator.pkl" --cfg Head
# Generate .ply mesh after video
    python gen_videos_proj_withseg.py --output="${output_dir}/${model}/${i}/PTI_render/post.mp4" --latent="${output_dir}/${model}/${i}/projected_w.npz" --trunc 0.7 --network "${output_dir}/${model}/${i}/fintuned_generator.pkl" --cfg Head --shapes True
